defmodule FeedbackCupcakeWeb.Components.Notification.Helpers do
  @moduledoc false

  alias Phoenix.LiveView.JS

  # def notification_classes, do: "pr-3 select-none drop-shadow flex items-center animate-[slide-in_300ms_ease-out]"
